...
//        @PathVariable Long sampleId, @AuthenticationPrincipal UserDetailsImpl userDetails) { // UserDetailsImpl이 현재 없음. 원래는 추가 필요.
//        return RestResponse.success(sampleService.getSample(sampleId, userDetails.getUser().getId()));
//    }
...
//        sampleSaveReq.setUserId(userDetails.getUser().getId()); // user Entity를 그대로 보내주기 보다는 dto에 담아서 전달
