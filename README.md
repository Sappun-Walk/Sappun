...
|                                    -프로필 기능<br>-아이디/이름<br>중복 확인<br>-[카카오, 네이버] 소셜로그인                                     |                                  -[게시글, 댓글]<br>좋아요, 신고 <br>관련 기능                                   |                                    -인증/인가<br>-회원가입, <br>회원탈퇴<br>-로그인, 로그아웃(인증인가)<br>-CI/CD(배포)                                   |                          -댓글 기능 <br>(사진첨부)<br>-S3 <br>-이미지 <br>리사이징<br>-CSS                     |                                   -게시글 기능<br>-지도 API 연동<br>-NGINX, HTTPS                                |
